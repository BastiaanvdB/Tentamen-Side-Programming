...
var ImageRequestQueueName = 'image-requests'
var ImagewriteRequestQueueName = 'image-write-requests'
...
resource ImageRequestQueue 'Microsoft.Storage/storageAccounts/queueServices/queues@2022-09-01' = {
    name: '${storageAccount.name}/default/${ImageRequestQueueName}'
    properties: {
        metadata: {}
  }
}
...
resource ImageTextWriteQueue 'Microsoft.Storage/storageAccounts/queueServices/queues@2022-09-01' = {
    name: '${storageAccount.name}/default/${ImagewriteRequestQueueName}'
    properties: {
        metadata: {}
  }
}
